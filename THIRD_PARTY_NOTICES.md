...
2. Make the corresponding source code for the GPL-covered components and the combined work available as required.
3. Provide installation information where GPLv3 requires it.
4. Confirm codec patent and distribution obligations for every country in which the APK is offered.
